...
class Profile(Base):
    ...
    last_scraped = Column(DateTime, default=datetime.utcnow, nullable=False, index=True)
    last_changed = Column(DateTime, default=datetime.utcnow, nullable=False, index=True)
    is_contacted   = Column(Boolean, default=False, index=True)
    contacted_at   = Column(DateTime, nullable=True)
    contacted_note = Column(Text, nullable=True)
    is_visited     = Column(Boolean, default=False, index=True)
